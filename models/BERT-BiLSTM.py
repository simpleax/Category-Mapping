...
class Model(BaseModel):
    def __init__(self) -> None:
        ...
        self.relu = nn.ReLU()
        # bilstm
        self.lstm = nn.LSTM(768, 768, num_layers=1, bidirectional=True, batch_first=True)
    ...
    def forward(self, token1_ids, segment1_ids):
        ...
        feature_output = get_pool_emb(hidden_state=lstm_output, attention_mask=token1_ids.gt(0).long(),
                                      pool_strategy='mean')
